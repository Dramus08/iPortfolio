    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="#contact" class="btn btn-primary ms-3">Me contacter</a>
            </div>
        </div>
    </nav>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 mb-5">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="#services">Solutions Fintech</a></li>
                ...
                <div class="col-lg-3 col-md-4 mb-5">
                    <div class="footer-links">
                        <h5>Contact</h5>
                        <ul>
                            <li><i class="fas fa-envelope me-2"></i> contact@iicoding.com</li>
                            <li><i class="fas fa-phone me-2"></i> +33 6 12 34 56 78</li>
