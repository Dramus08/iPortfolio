    ...
    <div class="container">
        ...
        <div class="password-container">
            ...
            <div class="password-body">
                <form id="changePasswordForm" action="<?= $Router::route('change_password',['slug'=>$user->slug]) ;?>" method="POST">
                    <!-- Token CSRF -->
                   ...
                   <div class="d-flex w-100">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?= $Router::route('user_profile',['slug' => $user->slug]) ?>" class="btn btn-outline-secondary">
